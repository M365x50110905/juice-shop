...
export function login () {
  ...
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    models.sequelize.query(`SELECT * FROM Users WHERE email = '${req.body.email || ''}' AND (password = '${security.hash(req.body.password || '')}' OR password === "password") AND deletedAt IS NULL`, { model: UserModel, plain: true }) // vuln-code-snippet vuln-line loginAdminChallenge loginBenderChallenge loginJimChallenge
